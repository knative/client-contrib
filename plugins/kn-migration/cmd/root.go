...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.knmt.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".knmt" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".knmt")
	}
